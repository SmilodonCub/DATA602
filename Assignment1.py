...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  4 10:00:40 2020
...
def exercise04():
    # Create two string variables. The first variable is called first_name, 
    #the second is last_name. 
    #Set both variables to your first name and last name respectively.
...
def exercise05():
    ...
    # Repeate exercise 4 here and assign the datatype of the 
    # variable first_name to a variable called name_type
...
def exercise06():
    # Assign 20 to the variable hours_worked, 15 to the variable wage_per_hour 
    # and the product of the two to variable total_pay
...
def exercise07():
    # Create a variable wage and assign 17.0 to it. 
    # Print to the screen the datatype of wage. 
...
def exercise08():
    # Assign 5 to the variable quantity, 
    # 'hello' to the variable hello and a variable hello_repeated 
    # that holds a string that contains whatever is contained 
    # in the variable hello repeated quantity times
...
def exercise09():
    # Assign 10 to a variable qty, 
    # 5 to a variable price and the product of the two to a variable total_cost
...
def exercise10():
    ...
    # and set them to 1 through 5, respectively. 
...
def exercise13():
    ...
    # Set r to 7 and calculate the volume of the sphere with r = 7 and 
...
def exercise14():
    # Create a variables area, length, height. 
    # Set length and height equal to 50 and 10.2 respectively. 
...
def exercise16():
    # Implement pythogorean thereom and find the length of hypotenuse c 
    # given sides a and b. Select any numbers for a and b. 
